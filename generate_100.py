...
MODEL_NAME = "gemma3:12b"  # Use your downloaded model name

topics = [
    "Java", "Python", "C++", "DSA", "Blockchain", "AI", "ML", "Databases",
    "Networks", "Operating Systems", "OOP", "Data Science", "Security", "Web Development"
]
